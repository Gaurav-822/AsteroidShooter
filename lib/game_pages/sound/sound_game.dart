...
import 'package:flame_demo/game_pages/sound/enemy.dart';
import 'package:flame_demo/game_pages/sound/player.dart';
import 'package:flutter/material.dart';

class SoundGame extends FlameGame with PanDetector, HasCollisionDetection {
  late BuildContext context;

  SoundGame(this.context);
  late Player player;
