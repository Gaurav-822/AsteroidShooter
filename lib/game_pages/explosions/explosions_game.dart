...
import 'package:flame_demo/game_pages/explosions/enemy.dart';
import 'package:flame_demo/game_pages/explosions/player.dart';
import 'package:flutter/material.dart';

class ExplosionsGame extends FlameGame with PanDetector, HasCollisionDetection {
  late BuildContext context;

  ExplosionsGame(this.context);
  late Player player;
